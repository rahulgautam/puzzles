...
function getHelp()
{	
    canvasHeading.innerHTML="<pre> Info : Try to solve the puzzle by Blacking out \
    <br> the given squares such that it satisfies \
    <br/> both horizontal & vertical conditions.</pre>";
}
